...
const typeLabels: Partial<Record<FinancialTxnType, string>> = {
  ...
  CAMPAIGN_ESCROW_RELEASE: "Escrow / odeme",
  PLATFORM_FEE: "Platform ucreti",
  REFUND: "Iade",
};

export default function MarkaIslemGecmisiPage() {
  ...
  return (
    <div className="mx-auto max-w-[960px] space-y-6">
      <p className="text-sm text-gray-600">Cuzdan hareketleri, kampanya odemeleri ve cekim kayitlari.</p>
            ...
            {loading ? (
              ...
              rows.map((r) => (
                <tr key={r.id} className="border-b border-gray-50 last:border-0">
                  ...
                  <td className="px-4 py-3 text-gray-800">{typeLabels[r.type] ?? r.type}</td>
                  ...
                  <td className="max-w-[220px] truncate px-4 py-3 text-xs text-gray-500" title={r.note ?? ""}>
